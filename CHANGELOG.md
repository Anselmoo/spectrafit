...
- fix: :construction_worker: Update `ci` workflow for auto-release (#1033) @Anselmoo
...
- docs: :card_index_dividers: Update CHANGELOG for release/v0.22.7 (#1032) @Anselmoo

### :package: Full Changelog

**Full Changelog**: https://github.com/Anselmoo/spectrafit/compare/v0.22.7...v0.22.8
