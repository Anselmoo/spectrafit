...
- fit with missing components produces a clear validation error
...
@pytest.mark.integration
class TestFitMissingComponents:
    def test_missing_components_shows_clear_error(self, tmp_path: Path) -> None:
        ...
        config = {
            ...
            "components": [],  # empty — must be rejected clearly
        }
        ...
        assert "component" in combined or "valid" in combined or "error" in combined
